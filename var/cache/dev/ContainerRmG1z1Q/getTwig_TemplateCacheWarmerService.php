...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel')), '/code/src', array('/code/templates' => NULL, '/code/vendor/symfony/twig-bridge/Resources/views/Form' => NULL)));
