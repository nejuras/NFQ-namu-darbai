...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\EmailsType' => function () {
    return ($this->privates['App\Form\EmailsType'] ?? $this->privates['App\Form\EmailsType'] = new \App\Form\EmailsType());
}, 'App\\Form\\GiftListType' => function () {
