...
$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), array(0 => '/code/src/Entity')), 'App\\Entity');
...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\GiftListRepository' => function () {
    return ($this->privates['App\Repository\GiftListRepository'] ?? $this->load('getGiftListRepositoryService.php'));
}, 'App\\Repository\\GiftRepository' => function () {
    return ($this->privates['App\Repository\GiftRepository'] ?? $this->load('getGiftRepositoryService.php'));
}))));
